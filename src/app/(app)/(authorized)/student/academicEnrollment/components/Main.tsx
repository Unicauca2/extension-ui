...
export const subjectsAssigned = [];  //Envío de Front a Back
    ...
    <main className="h-5/6 my-auto  mb-3 bg-[#ffffff] rounded-bl-3xl rounded-tr-3xl">
      ...
      <Box className="w-9/10 h-5/6 m-2 flex">
        <div className="w-1/3 flex-1 h-full mr-2 border-[#000066] border-2 rounded-bl-3xl text-center">
          <p className="my-4 font-bold font-sans text-base text-[#000066]">Aquí podras realizar tu matrícula académica</p>
          
          <List className="h-[47vh] m-0 p-1 overflow-auto">
            <Box className="w-full px-0 pt-0 pb-2 align-top flex">
              <div className="h-7 m-0 px-2 py-0 text-white bg-[#0772B5] rounded-3xl font-bold">1</div>
              <div className="justify-start">
                <p className="my-0 mx-full font-semibold font-sans text-base text-[#000066]">Puedes arrastrar y soltar en el horario una de las materias disponibles para ti: </p>
                <ListSubjects dragActive={dragActive} setDragActive={setDragActive} dragSubject={dragSubject} hours={hours} subjectsEnable={subjectsEnable}/>
              </div>
            </Box>
            <Box className="w-full px-0 pt-0 pb-2 align-top flex">
              <div className="h-7 m-0 px-2 py-0 text-white bg-[#0772B5] rounded-3xl font-bold">2</div>
              <div className="justify-start">
                <Button 
                  onClick={()=>{return console.log("Confirmar Matrícula: ",subjectsAssigned);}} 
                  endIcon={<TaskIcon />}
